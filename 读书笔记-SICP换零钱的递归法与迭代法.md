...
>这个方法我试了，对于1000这个总钱数，从**递归法**的***333082021***次调用，到上述**迭代法**的***4732860***次调用，最后到这个**优化迭代法**的***801871***调用（总换法是***801451***，个人觉得对于这种遍历的算法，真是优化到了极致😄），每一次都是一个数量级的提升。具体优化后的代码就不贴了，看了太多代码也会烦吧。
